...
img1 = face_recognition.load_image_file('gourav.jpg')
img1 = cv2.cvtColor(img1, cv2.COLOR_BGR2RGB)
img1Test = face_recognition.load_image_file('gourav.jpg')
...
cv2.imshow('gourav', img1)
cv2.imshow('gourav Test', img1Test)
cv2.waitKey(0)
